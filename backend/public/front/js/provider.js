                            ...
                            <div class="card mb-2">
                                ...
                                : "N/A"
                                        ...
                                        <div class="strike-info mx-2">
                                                <span class="badge badge-soft-warning ms-1">${item.user_form_input
                                .category.name || "N/A"
                            }</span>
                                            </div>
                                ...
                                item.status
                                            ...
                                            <div class="d-flex align-items-center">
                                                <a href="#" class="text-decoration-none me-3 view-lead-detail"
                                                   data-id="${item.user_form_input.id
                            }"
        ...
        $.ajax({
            ...
            success: function (response) {
                ...
                if (
                    ...
                    $(".sub_category").text(
                        `Sub Category: ${userFormInput.sub_category?.name
                               ...
                               <tr>
                                ...
                                <td>
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div>
                                            <h6 class="fs-14 fw-medium"><a href="#">${staff.first_name
                                } ${staff.last_name}</a></h6>
                                            <span class="fs-12">${staff.email
                                }</span>
                                        </div>
                                    </div>
                                </td>
                                ...
                                <td>
                                    <div class="d-flex align-items-center">
                                        <span class="badge ${staff.status == "1"
                                    ? "badge-soft-success"
                                    : "badge-soft-danger"
...
if (pageValue === "provider.add.service") {
    ...
    let branchEmptyInfo = 'No branches found at the moment. You can proceed further.';
        ...
        $.ajax({
            ...
            success: function (response) {
                ...
                if (response.code === 200 && Object.keys(trans).length > 0) {
                    ...
                    if (trans['No branches found at the moment. You can proceed further.']) {
                        branchEmptyInfo = trans['No branches found at the moment. You can proceed further.'];
                    }
                    ...
                    if (branch.staff.length > 0) {
                        ...
                        branch.staff.forEach((staff) => {
                            ...
                            <div class="d-flex align-items-center mb-3">
                                ...
                                <div>
                                    <div class="fs-14 fw-semibold">${staff.user.first_name
                                } ${staff.user.last_name}</div>
                                    <p class="mb-0 text-muted fs-12">${staff.user.mobile_number ||
                                "No Mobile Number"
                                }</p>
                                </div>
                                <div class="ms-auto">
                                    <input type="checkbox" name="staff_select[]" value="${staff.user.user_id
                                }" class="staff-checkbox" data-branch-id="${branch.branch.id
                                }" disabled>
                                </div>
                            </div>`;
                        });
                        ...
                        <tr>
                                ...
                                <td>
                                    <div class="form-check form-switch">
                                        <input class="form-check-input serviceId" ${Service.status == 1
                        ? "checked"
                        : ""
                    } type="checkbox"
                                ...
                                <td>
                                    <div class="d-flex align-items-center">
                                        <span class="badge ${Service.verified_status == 1
                        ? "badge-soft-success"
                        : "badge-soft-danger"
                    } d-flex align-items-center">
                                            <i class="ti ti-point-filled"></i>
    ...
    function renderSubscriptionCards(data) {
        ...
        data.forEach((plan) => {
            ...
            if (plan.package_duration) {
                innerHTML += `<li class="justify-content-start"><i class="fa fa-check"></i>${plan.package_duration ?? "0"
                    } ${plan.package_term ?? "0"} / Duration</li>`;
            }
            if (plan.number_of_service) {
                innerHTML += `<li class="justify-content-start"><i class="fa fa-check"></i>${plan.number_of_service ?? "0"
                    } / No of Service</li>`;
            }
            if (plan.number_of_locations) {
                innerHTML += `<li class="justify-content-start"><i class="fa fa-check"></i>${plan.number_of_locations ?? "0"
                    } / No of Branch Location</li>`;
            }
            if (plan.number_of_staff) {
                innerHTML += `<li class="justify-content-start"><i class="fa fa-check"></i>${plan.number_of_staff ?? "0"
                    } / No of Staff</li>`;
            }
            if (plan.description) {
        ...
        $(document).on("click", ".subscribe", function () {
            ...
            if (amt != 0) {
                ...
                $.ajax({
                    url: "/api/storepackagetransaction",
                    type: "POST",
                    data: { provider_id: $("body").data("authid"), amount: amt, package_id: planid, type: "free" },
                    headers: {
                        Authorization:
                            "Bearer " + localStorage.getItem("admin_token"),
                        Accept: "application/json",
        ...
        success: function (response) {
            if (response.code == "200") {
                ...
                if (data !== null) {
                    ...
                    $(".order_completed_count").text(data.order_completed_count);
                ...
                if (data != "") {
                    data.forEach((val) => {
                            ...
                            <div class="card-body">
                                <div class="d-flex justify-content-between align-items-center flex-wrap row-gap-2">
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div>
                                            <a href="${val.product_slug ? "/servicedetail/" + val.product_slug : "#"}" class="fw-medium">${val.product_name}</a>
                        ...
                        if (val.average_rating != "") {
                            servicehtml += `<span><i class="ti ti-star-filled text-warning me-1"></i>${val.average_rating ?? 0
                                }</span>`;
                        }
                    ...
                    data.forEach((val) => {
                        ...
                        var servicehtml = `<div class="d-flex justify-content-between align-items-center mb-3">
                                <div class="d-flex">
                                    ...
                                    <div>
                                        <a href="${val.product_slug
                                ? "/servicedetail" +
                                val.product_slug
                                : "#"
                            }" class="fw-medium mb-0">${val.product_name
                            }</a>
                                        <div class="fs-12 d-flex align-items-center gap-2">`;
                        let booklabel = "Bookings";
                        if (languageId === 2) {
                        ...
                        if (val.average_rating != "") {
                            servicehtml += `<span><i class="ti ti-star-filled text-warning me-1 me-1"></i>${val.average_rating ?? 0
                                }</span>`;
                        }
                        servicehtml += `  </div>
                                    </div>
                        ...
                        transactions.forEach((transaction, index) => {
                            ...
                            tableBody += `
                                ...
                                transaction.service.name
                                    ...
                                    <td>${currency}${transaction.amount.total_amount
                                }</td>
                                    <td>${currency}${transaction.amount.commission
                                }</td>
                                    <td>${currency}${transaction.amount.final_total
                                }</td>
                                    <td>${formattedDate}</td>
                                    <td>${paymentType}</td>
                ...
                if (response.code === 200) {
                    ...
                    if (transactions.length === 0) {
                        ...
                        transactions.forEach((transaction, index) => {
                            ...
                            <td>
                                <div class="d-flex align-items-center">
                                    <img src="${transaction.customer.profile_image
                        ...
                        payoutHistory.forEach((payout, index) => {
                            tableBody += `
                                <tr>
                                    ...
                                    <td>${currencySymbol}${payout.total_amount
                                }</td>
                                    <td>${currencySymbol}${payout.processed_amount
                                }</td>
                                    <td>${payout.payment_method ?? "PayPal"
                                }</td>
                                    <td>
                                        <div class="d-flex align-items-center">
                                    ...
                                    <td>
                                        <div class="">
                                            <a href="${payout.payment_proof_path
                        ...
                        payoutHistory.forEach((payout, index) => {
                            tableBody += `
                                <tr>
                                    ...
                                    <td class="text-center">${currencySymbol}${payout.amount
                                }</td>
                                    <td>${payout.payment_method ?? "PayPal"
                                }</td>
                                    <td>
...
if (pageValue === "provider.subscriptionhistory") {
            ...
            list["historydata"].forEach((data) => {
                ...
                tableBody += `
                    <tr>
                       ...
                       <td><span class="payment-status fs-14" data-status="${data.payment_status
                    }">${data.paymentstatus}</spn></td>
                        <td><span class="active-status fs-14" data-status="${data.status
    ...
    function setupPagination(meta) {
        ...
        for (let i = 1; i <= meta.last_page; i++) {
            paginationHtml += `<li class="page-item ${meta.current_page === i ? "active" : ""
                                                    ...
                                                    <div class="d-flex justify-content-between align-items-center mb-3">
                                                        <div class="d-flex">
                                                            <span class="review-img me-2">
                                                                <img src="${review.service_image
                                }" class="rounded img-fluid" alt="Service Image">
                                                            </span>
                                                            <div>
                                                                <div class="d-flex justify-content-between align-items-center mb-2">
                                                                    <div class="d-flex align-items-center">
                                                                        <h6 class="fs-14 me-2">${review.service_name
                                }</h6>
                                                                        ${filledStars}
                                                                    </div>
                                                                </div>
                                                                <div class="d-flex align-items-center">
                                                                    ...
                                                                    <h6 class="fs-13 me-2">${review.full_name
                                }</h6>
                                                                    <span class="fs-12">${review.review_date
                                }</span>
                                                                </div>
                                                            </div>
                                                        </div>
                    ...
                    for (let i = 1; i <= lastPage; i++) {
                        paginationLinks += `
                            <li class="page-item me-2">
                                <a class="page-link-1 ${i === currentPage ? "active" : ""
        ...
        $.ajax({
            ...
            success: function (response) {
                if (response && response.data && response.data.length > 0) {
                    ...
                    response.data.forEach((state) => {
                        stateDropdown.append(
                            `<option value="${state.id}" ${state.id == $("#state").data("state")
                                ? "selected"
                                : ""
                            }>${state.name}</option>`
                        );
        ...
        $.ajax({
            ...
            success: function (response) {
                if (response && response.data && response.data.length > 0) {
                    ...
                    response.data.forEach((city) => {
                        stateDropdown.append(
                            `<option value="${city.id}" ${city.id == $("#city").data("city")
                                ? "selected"
                                : ""
                            }>${city.name}</option>`
                        );
                    ...
                    if (permissions.length === 0) {
                        ...
                        permissions.forEach((permission, index) => {
                            ...
                            tableBody += `
                                <tr>
                                    <td>${index + 1}</td>
                                    <td data-id="${permission.id}">${permission.module
                                }</td>
                                    <td>
                    ...
                    .done((response) => {
                        ...
                        <div class="card">
                            <div class="card-body p-0">
                                        ...
                                        <div class="mb-2">
                                            <div class="d-flex flex-wrap align-items-center mt-3">
                                                <h6 class="fw-semibold me-2 mb-0">
                                                    <a onclick="storeTicketId(${response.ticketdata.id
                                ...
                                } d-flex align-items-center ms-2 fs-10" data-status="${response.ticketdata.status
                                }">
                                ...
                                "-"
                                    ...
                                    ? `
                                        ...
                                        : "/assets/img/user-default.jpg"
                                                    ...
                                                    <span class="text-dark fw-semibold ms-1 assigneename">${response.ticketdata
                                        .assignee_name ??
                                    "-"
                                    }</span>
                                                </p>`
                                    : ""
                                                ...
                                                <p class="d-flex align-items-center mb-1 me-2 fs-10">
                                                    ...
                                                    <span class="fw-semibold text-muted me-1">Updated:</span> ${response.ticketdata
                                    .updated_at_relative
                                }
                                                </p>
                                            </div>
...
if (pageValue === "provider.product") {
    $(document).on("click", "#providerAddProduct", function (e) {
        e.preventDefault();
        const authId = $("#auth_id").val();
        $.ajax({
            url: "/provider/subscription/detail",
            ...
            beforeSend: function () {
                $("#providerAddProduct").attr("disabled", true);
                $("#providerAddProduct").html(
                    '<div class="spinner-border text-light" role="status"></div>'
                );
            },
        })
            .done((response, statusText, xhr) => {
                $("#providerAddProduct").removeAttr("disabled");
                $("#providerAddProduct").html("Add Product");
                ...
                if (response.code === 200) {
                    if (response.no_package === true) {
                        ...
                        window.location.href = "/provider/product/create";
                    }
                }
            })
            .fail((error) => {
...
if (pageValue === "provider.add.product") {
    ...
    $(document).ready(function () {
            ...
            $.ajax({
                ...
                success: function (response) {
                    ...
                    if (response.code === 200 && Object.keys(trans).length > 0) {
                        ...
                        $("#service_btn").show();
                        $("#serviceLoader").hide();
                        $(".label-skeleton, .input-skeleton").hide(); // Use generic skeleton class or specific?
                        $(".label-loader, .input-loader").hide(); // Specific from providerAddProduct.blade.php
                        $(".real-label, .real-input").removeClass("d-none");
                    }
                },
                error: function (error) {
                    // hide on error too to allow editing? Or show error?
                    $("#serviceLoader").hide();
        ...
        // Category change listener to fetch subcategories
        $(document).on('change', '.categoryProviderSelect', function () {
            let categoryId = $(this).val();
            let langId = $("#userLangId").val() || 1;
            fetchProductSubcategories(langId, categoryId);
        });
    });

    function fetchProductCategories(languageId) {
        $.ajax({
            url: "/api/get-categories",
            type: "POST",
            data: { language_id: languageId },
            ...
            success: function (data) {
                ...
                $(".categoryProviderSelect").html(options);
            }
        });
    }

    function fetchProductSubcategories(languageId, categoryId) {
        $.ajax({
            url: "/get-subcategories",
            type: "POST",
            data: { language_id: languageId, category_id: categoryId },
    ...
    // Wizard Navigation
    $(document).ready(function () {
        // Step 1: Info -> (Skip Branch) -> Gallery
        $("#service_btn").on("click", function () {
            if ($("#product-form").valid()) {
                $("#first-field").hide();
                // Skip second-field (branch) for products, go straight to third-field (gallery)
                $("#second-field").hide();
                $("#third-field").show();

                // Update Progress Bar
                $("#progressbar li").removeClass("active");
                $("#progressbar li:nth-child(1)").addClass("active"); // Info
                $("#progressbar li:nth-child(2)").addClass("active"); // Branch (skipped but marked)
                $("#progressbar li:nth-child(3)").addClass("active"); // Gallery
            }
        });
