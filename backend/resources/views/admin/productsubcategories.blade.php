            ...
            <div class="my-auto mb-2">
                ...
                <nav>
                    <ol class="breadcrumb mb-0">
                        ...
                        <li class="breadcrumb-item">
                            <a href="javascript:void(0);">{{ __('Production') }}</a>
                        </li>
                                    ...
                                    <div class="modal-body">
                                        <div class="row">
                                            <div class="col-lg-12">
                                                ...
                                                <div class="mb-3">
                                                    <label class="form-label" data-translate="category">{{ __('Category') }}</label>
                                                    <select class="form-select" name="category_id" id="category_id" data-select="{{ __('Select') }}">
                                                        <option value="">{{ __('Select') }}</option>
                                                        @if ($categories->isNotEmpty())
                                                        @foreach ($categories as $category)
                                                        <option value="{{ $category->id }}">{{ $category->name }}</option>
                                                ...
                                                <div class="mb-3">
                                                    <label class="form-label" data-translate="sub_category_name">{{ __('sub_category_name') }}</label>
