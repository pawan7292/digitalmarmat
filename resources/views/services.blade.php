@extends('front')
@section('canonical')
<link rel="canonical" href="https://digitalmarmat.com/services">
@endsection
				...
				<div class="col-xl-9 col-lg-8">
					...
					<nav aria-label="Page navigation">
						<ul class="paginations d-flex justify-content-center align-items-center">
							...
							<li class="page-item me-2">
								<a class="page-link-1 d-flex justify-content-center align-items-center {{ $products->currentPage() == $page ? 'active' : '' }}"
									href="{{ $url }}">{{ $page }}</a>
							</li>
							@endforeach
...
document.addEventListener("DOMContentLoaded", function() {
    ...
    form.addEventListener("submit", function (e) {
        ...
        form.querySelectorAll("input[name], select[name]").forEach((input) => {
            ...
            // Price default value 0;0 → remove
            if (input.name === "range_price" && input.value === "0;0") {
