...
interface AllServicesSearchBarProps {
  currentFilters?: ServiceQueryParams;
}

export default function AllServicesSearchBar({
  currentFilters = {},
}: AllServicesSearchBarProps) {
  ...
  const submit = (e?: FormEvent) => {
    ...
    if (currentFilters?.sort && currentFilters.sort !== "most_viewed") {
    ...
    router.push(`/all-services${queryString ? `?${queryString}` : ""}`);
