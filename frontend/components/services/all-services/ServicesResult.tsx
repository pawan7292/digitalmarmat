    ...
    <div className="grid grid-cols-1 xs:grid-cols-2 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-2 sm:gap-3 md:gap-4 w-full px-2 sm:px-4">
      {services.map((eachService, index) => {
        return (
          ...
          >
            <div className="rounded-lg shadow-sm overflow-hidden hover:shadow-md transition h-full hover:shadow-xl hover:-translate-y-2 hover:scale-[1.03]">
              ...
              <div className="p-2 sm:p-3">
                <div className="font-bold line-clamp-1 text-xs sm:text-sm md:text-base hover:text-brand-raiden-500">
                  {eachService.name}
                </div>
