  ...
  return (
    <div className="relative w-full max-w-2xl md:max-w-[min(40vw,36rem)]">
      ...
      <button
        ...
        className="flex gap-2 items-center hover:cursor-pointer hover:bg-brand-raiden-600 body absolute right-2 top-4 bottom-2 px-5 rounded-lg bg-brand-raiden-500 text-white font-medium hover:bg-bloody-ruby-500 transition"
      >
