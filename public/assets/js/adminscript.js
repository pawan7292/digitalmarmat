...
if (pageValue === "admin.currency-settings") {
    ...
    $(document).on("click", ".currency_delete_btn", function (e) {
        ...
        $.ajax({
            ...
            error: function (xhr) {
                toastr.error(xhr.responseJSON.message || "An error occurred while deleting currency.");
            },
        });
    });
...
if (pageValue === "settings.email-templates") {
    ...
    $(document).on("click", '.delete_template',
        function (e) {
            e.preventDefault();
                ...
                tableBody += `
                    <tr>
                            ...
                            ${
                                ...
                                <li style="list-style: none;">
                                    ${
                                        ($("#has_permission").data("edit") == 1 && Section.id != 17  && Section.id != 18 && Section.id != 19 && Section.id != 20)
