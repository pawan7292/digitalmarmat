...
if(pageValue == 'admin.productcategories') {
    ...
    $('#categoryForm').validate({
        ...
        submitHandler: function (form) {
            ...
            $.ajax({
                url: "/api/product-categories/save",
                type: "POST",
                data: formData,
...
if(pageValue == 'admin.form-categories') {
    $(document).ready(function() {
        ...
        $('#addFormsInputForm').on('submit', function(e) {
            ...
            $.ajax({
                url: '/api/product-categories/form-inputs',
                type: 'POST',
                data: formData,
                contentType: false,
                processData: false,
        ...
        function loadFormInputList() {
            $.ajax({
                url: '/api/product-categories/form-inputs/list',
                type: 'POST',
                data: {
                    category_id: categoryId,
                },
        ...
        function updateFormOrder(orderData) {
            $.ajax({
                url: '/api/product-categories/form-inputs/order',
                type: 'POST',
                headers: {
                    'Authorization': 'Bearer ' + localStorage.getItem('admin_token'),
                    'Accept': 'application/json',
        ...
        $(document).on('click', '#confirmDelete', function(e) {
            ...
            $.ajax({
                url: '/api/product-categories/form-inputs/delete',
                type: 'POST',
                data: {
                    id: formInputId,
                },
